...
arma::cx_mat potential(double v0, double M, int size_slit, int size_between_slit);
void vector_ab(arma::cx_double r, double dt, double M, arma::cx_vec &a, arma::cx_vec &b, arma::cx_mat V);
void matrix(arma::cx_double r, arma::cx_vec a, arma::cx_vec b, arma::sp_cx_mat &A, arma::cx_mat &B, double M);
arma::cx_cube CrankNicolson(arma::cx_mat U, arma::cx_mat B, arma::sp_cx_mat A, double M, int N);
