...
// declaring functions
arma::cx_mat initial(double mean_x, double mean_y, double var_x, double var_y, double p_x, double p_y, int M);
...
arma::cx_cube CrankNicolson(arma::cx_mat U, arma::cx_mat B, arma::sp_cx_mat A, int M, int N);
void write_to_file(arma::cx_cube U_cube);
