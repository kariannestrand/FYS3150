...
void vector_ab(double r, double dt, int M, arma::cx_vec &a, arma::cx_vec &b, arma::cx_mat V);
void matrix(double r, arma::cx_vec a, arma::cx_vec b, arma::sp_cx_mat &A, arma::cx_mat &B, int M);
arma::cx_vec CrankNicolson(arma::cx_mat U_in, arma::cx_mat B, arma::sp_cx_mat A, double t);
