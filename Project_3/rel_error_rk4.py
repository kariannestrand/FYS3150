...
# loading files for dt = 0.015
V_1 = pa.mat()
V_1.load("RK4_v_0_0015dt.bin")
vel_1 = np.transpose(V_1)

vy_1 = vel_1[:, 1]

R_1 = pa.mat()
R_1.load("RK4_r_0_0015dt.bin")
...
# loading files for dt = 0.008
V_2 = pa.mat()
V_2.load("RK4_v_0_0008dt.bin")
vel_2 = np.transpose(V_2)

vy_2 = vel_2[:, 1]

R_2 = pa.mat()
R_2.load("RK4_r_0_0008dt.bin")
...
# loading files for dt = 0.004
V_3 = pa.mat()
V_3.load("RK4_v_0_0004dt.bin")
vel_3 = np.transpose(V_3)

vy_3 = vel_3[:, 1]

R_3 = pa.mat()
R_3.load("RK4_r_0_0004dt.bin")
...
V_4 = pa.mat()
V_4.load("RK4_v_0_0001dt.bin")
vel_4 = np.transpose(V_4)

vy_4 = vel_4[:, 1]

R_4 = pa.mat()
R_4.load("RK4_r_0_0001dt.bin")
...
V_5 = pa.mat()
V_5.load("RK4_v_0_00008dt.bin")
vel_5 = np.transpose(V_5)

vy_5 = vel_5[:, 1]

R_5 = pa.mat()
R_5.load("RK4_r_0_00008dt.bin")
...
plt.title('Relative error with RK4')
plt.plot(t_1, rel_err_1, label = 'dt = 0.015')
plt.plot(t_2, rel_err_2, label = 'dt = 0.008')
plt.plot(t_3, rel_err_3, label = 'dt = 0.004')
plt.plot(t_4, rel_err_4, label = 'dt = 0.001')
plt.plot(t_5, rel_err_5, label = 'dt = 0.0008')
plt.xlabel('t[$\mu s$]')
plt.ylabel('$\epsilon$')
plt.legend()
...
if relative_error_RK4:
    filename_r_list = ["RK4_r_0_0015dt.bin", "RK4_r_0_0008dt.bin", "RK4_r_0_0004dt.bin", "RK4_r_0_0001dt.bin", "RK4_r_0_00008dt.bin"]
    filename_v_list = ["RK4_v_0_0015dt.bin", "RK4_v_0_0008dt.bin", "RK4_v_0_0004dt.bin", "RK4_v_0_0001dt.bin", "RK4_v_0_00008dt.bin"]
    dt_list = [0.015, 0.008, 0.004, 0.001, 0.0008]
