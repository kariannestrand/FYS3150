...
public:
    ...
    PenningTrap(double B0, double V0, double d, double ke, double f, arma::vec omega_v, int n, double N, arma::vec r1, arma::vec v1, arma::vec q_vec, arma::vec m_vec, bool write, bool interaction, bool modified);
    /*
    // constructor
